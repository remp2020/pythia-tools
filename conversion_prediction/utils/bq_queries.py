...
def filter_by_date(
    ...
    filtered_data = bq_session.query(
        filtered_data['date'].label('date'),
        filtered_data['browser_id'].label('browser_id'),
        filtered_data['user_ids'].label('user_ids'),
        filtered_data['pageviews'].label('pageviews'),
        filtered_data['timespent'].label('timespent'),
        filtered_data['sessions'].label('sessions'),
        filtered_data['sessions_without_ref'].label('sessions_without_ref'),
        filtered_data['browser_family'].label('browser_family'),
        filtered_data['browser_version'].label('browser_version'),
        filtered_data['os_family'].label('os_family'),
        filtered_data['os_version'].label('os_version'),
        filtered_data['device_family'].label('device_family'),
        filtered_data['device_brand'].label('device_brand'),
        filtered_data['device_model'].label('device_model'),
        filtered_data['is_desktop'].label('is_desktop'),
        filtered_data['is_mobile'].label('is_mobile'),
        filtered_data['is_tablet'].label('is_tablet'),
        filtered_data['next_7_days_event'].label('next_7_days_event'),
        filtered_data['next_event_time'].label('next_event_time'),
        filtered_data['referer_medium_pageviews'].label('referer_medium_pageviews'),
        filtered_data['article_category_pageviews'].label('article_category_pageviews'),
        filtered_data['hour_interval_pageviews'].label('hour_interval_pageviews'),
        filtered_data['pageviews_0h_4h'].label('pageviews_0h_4h'),
        filtered_data['pageviews_4h_8h'].label('pageviews_4h_8h'),
        filtered_data['pageviews_8h_12h'].label('pageviews_8h_12h'),
        filtered_data['pageviews_12h_16h'].label('pageviews_12h_16h'),
        filtered_data['pageviews_16h_20h'].label('pageviews_16h_20h'),
    ).subquery()
