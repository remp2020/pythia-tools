...
def churn_or_renewed_users(cursor, subscriptions_stop_date, churn_days_threshold):
    print("Loading churn/renewal users data for date " + str(subscriptions_stop_date) + ", churn threshold " + str(churn_days_threshold) + " days")
...
def save_events(cursor, subscriptions_stop_date, churn_events, event_name):
...
def run(churn_date):
    ...
    churn_events_list, renewal_events_list = churn_or_renewed_users(crm_db_cur, subscriptions_stop_date, churn_days_threshold)
